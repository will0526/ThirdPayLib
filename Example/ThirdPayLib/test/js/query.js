...
function queryVoucher(queryVoucherObject,callback){
    ...
    var paramsStr = JSON.stringify({
        ...
        "merchantNo":queryVoucherObject.merchantNO,
        "orderAmount":queryVoucherObject.orderAmount,
...
//查询优惠券和活动，线上买单
function requestVoucherAndCampaign(queryVoucherAndCampaignObject,callback){
...
//查询会员活动，线上买单
function requestMemberCampaign(queryMemberCampaignObject,callback){
...
function doPost(paramsStr,paramsSign,callback){
    ...
    $.ajax({
        type: "POST",
        url: "http://ippuat.pnrtec.com/front/gateway/sdk/interface.json",
