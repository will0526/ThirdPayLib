...
- (void)viewDidLoad {
    ...
    switch (_viewType) {
        case 0:
        {
            ...
            defaultSource = @[@"1402A001",@"000000000000005",@"13818181818",@"2",merchantOrder,@"手机订单标题",@"苹果手机6s和iPhone7 正品行货",@"10000",@"10000",@"10000",@"0000001",@"000000000000005",@"iPhone6s 灰色",@"5000",@"0000002",@"000000000000005",@"iPhone7 灰色",@"5000",@"1499395966000238",@"",@"不支持货到付款",@"http://www.baidu.com",@"http://www.baidu.com"];
        }
            break;
        case 1:
        {
            ...
            defaultSource = @[@"1402A001",@"000000000000005",@"13818181818",@"2",merchantOrder,@"手机订单标题",@"苹果手机6s和iPhone7 正品行货",@"10000",@"10000",@"10000",@"0000001",@"000000000000005",@"iPhone6s 灰色",@"5000",@"0000002",@"000000000000005",@"iPhone7 灰色",@"5000",@"",@"",@"不支持货到付款",@"http://www.baidu.com",@"http://www.baidu.com",@"",@"",@"",@"",@"",@"",@""];
...
//            _pickerView.hidden = YES;
        ...
        case 2:{
            ...
            defaultSource = @[@"1402A001",@"000000000000005",@"13818181818",@"2",@"10",@"",@""];
        ...
        case 3:{
            ...
            defaultSource = @[@"1402A001",@"000000000000005",@"13818181818",@"2"];
        ...
        case 4:{
            self.title = @"营销活动查询";
            dataSource = @[@"项目号",@"商户号"];
            defaultSource = @[@"1402A001",@"000000000000005"];
