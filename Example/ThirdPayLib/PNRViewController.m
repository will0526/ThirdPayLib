...
- (void)viewDidLoad {
    ...
    switch (_viewType) {
        case 0:
        {
            ...
            defaultSource = @[@"1402A001",@"000000000000005",@"13818181818",@"2",merchantOrder,@"手机订单标题",@"苹果手机6s和iPhone7 正品行货",@"100",@"100",@"100",@"0000001",@"000000000000005",@"iPhone6s 灰色",@"5",@"0000002",@"000000000000005",@"iPhone7 灰色",@"5",@"",@"",@"不支持货到付款",@"http://www.baidu.com",@"http://www.baidu.com"];
        }
            break;
        case 1:
        {
