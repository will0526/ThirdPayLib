...
#define TESTBASEURL @"https://ippuat.pnrtec.com/front/gateway/sdk/interface.json"//URL
#define SALT @"fTWFH3QRH7gSs3DE"

#define BASEURL @"http://ipp.pnrtec.com/front/gateway/sdk/interface.json"//URL
